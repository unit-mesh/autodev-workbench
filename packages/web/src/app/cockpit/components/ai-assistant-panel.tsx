...
import { AlertTriangle, CheckCircle, FileDown, FileSearch, HelpCircle, Star } from "lucide-react"
		...
		<div className="bg-white border-l border-gray-200 flex flex-col h-full">
			...
			<div className="p-3 border-b border-t border-gray-200">
				...
				<div className="grid grid-cols-3 gap-2">
					<Button variant="outline" className="w-full text-sm justify-start" disabled>
				...
				<div className="mt-2">
					<Button
						className="w-full text-sm justify-start text-white"
