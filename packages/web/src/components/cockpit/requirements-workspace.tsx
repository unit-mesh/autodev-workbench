		...
		<div className="flex-1 flex flex-col h-full border-l border-r border-gray-200">
			...
			<Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col h-full">
				...
				<div className="flex-1 relative">
					<TabsContent value="conversation" className="absolute inset-0 m-0 data-[state=inactive]:hidden">
					...
					<TabsContent value="document" className="absolute inset-0 m-0 data-[state=inactive]:hidden">
													...
													<div className="space-y-3">
														<div className="flex justify-between items-center mb-3 pb-2 border-b border-gray-200">
															...
															<div className="flex gap-2">
																<Button variant="outline" size="sm" onClick={() => setEditingId(null)} className="hover:bg-gray-100">
																	取消
																</Button>
