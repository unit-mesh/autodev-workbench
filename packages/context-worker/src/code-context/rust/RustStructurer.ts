...
import { CodeFile, CodeFunction, CodeParameter, CodeStructure, StructureType } from "../../codemodel/CodeElement";
...
export class RustStructurer extends BaseStructurerProvider {
  ...
  protected config: RustProfile = LanguageProfileUtil.from(this.langId)!!;
  ...
  // 解析参数节点并提取参数信息
  private parseParameters(paramsNode: Parser.SyntaxNode, result: CodeParameter[]): void {
    // 遍历所有parameter子节点
